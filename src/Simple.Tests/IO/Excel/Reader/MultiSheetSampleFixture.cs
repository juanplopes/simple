...
namespace Simple.Tests.IO.Excel.Reader
{
    ...
    {
        SheetResultCollection<NullableData> data;
        ...
        public void Sheet1DataIsCorrect()
        {
            ...
            sheet[0].AssertWith("asd", 123, new DateTime(1915, 04, 13), NullableData.Status.Ativo, true);
            sheet[1].AssertWith("asd2", 234, new DateTime(1915, 04, 14), NullableData.Status.Ativo, false);
            sheet[2].AssertWith("asd3", 345, new DateTime(1915, 04, 15), NullableData.Status.Inativo, true);
            sheet[3].AssertWith("asd4", 456, new DateTime(1915, 04, 16), NullableData.Status.Cancelado, false);
        }
        ...
        public void Sheet2DataIsCorrect()
        {
            ...
            sheet[0].AssertWith(null, 123, new DateTime(1915, 04, 13), NullableData.Status.Ativo, true);
            sheet[1].AssertWith("asd2", null, new DateTime(1915, 04, 14), NullableData.Status.Ativo, false);
            sheet[2].AssertWith("asd3", 345, null, NullableData.Status.Inativo, null);
        ...
        public void Sheet3DataIsCorrect()
        {
            ...
            sheet[0].AssertWith("asd4", 456, new DateTime(1915, 04, 16), NullableData.Status.Cancelado, false);
        }
