...
namespace Simple.Tests.IO.Excel.Reader
{
    ...
    public class BasicDataFixture
    {
        ...
        public void Sheet1DataIsCorrect()
        {
            ...
            sheet[0].AssertWith("asd", 123, new DateTime(1915, 04, 13), BasicData.Status.Ativo, true);
            sheet[1].AssertWith("asd2", 234, new DateTime(1915, 04, 14), BasicData.Status.Ativo, false);
            sheet[2].AssertWith("asd3", 345, new DateTime(1915, 04, 15), BasicData.Status.Inativo, true);
            sheet[3].AssertWith("asd4", 456, new DateTime(1915, 04, 16), BasicData.Status.Cancelado, false);
        }
    }
}
