...
{
    [TestFixture]
    public class BasicSkippingRowsFixture
    {
        ...
        {
            data["Sheet1"].Records.Should().Have.Count.EqualTo(2);
        ...
        public void Sheet1DataIsCorrect()
        {
            ...
            sheet[0].AssertWith("asd3", 345, new DateTime(1915, 04, 15), BasicData.Status.Inativo, true);
            sheet[1].AssertWith("asd4", 456, new DateTime(1915, 04, 16), BasicData.Status.Cancelado, false);
        }
    }
}
