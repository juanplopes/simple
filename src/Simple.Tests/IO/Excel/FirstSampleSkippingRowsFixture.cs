...
{
    [TestFixture]
    public class FirstSampleSkippingRowsFixture
    {
        ...
        public void Sheet1DataIsCorrect()
        {
            ...
            sheet[1].AssertWith("asd4", 456, new DateTime(1915, 04, 16), FirstSampleData.Status.Cancelado, false);
        }
    }
}
